...
def main():
    ...
    # Run the 3x3 model
    model = ""
    with open(script_dir / "modular_3x3.modest", "r") as f:
        model = f.read()

    # Resistive 3x3 Simulations
    for thresh, clk in [(1,20),(5,30),(10,40),(20,60),(40,200)]:
        r = run_psn_analysis(max_clk=clk,
                             stride=1,
                             batch=100,
                             resistive_threshold=thresh,
    ...
    # Inductive 3x3 Simulations
    for thresh, clk in [(1,200),(5,300),(10,400)]:
        i = run_psn_analysis(max_clk=clk,
                             stride=5,
                             batch=100,
                             resistive_threshold=1,
