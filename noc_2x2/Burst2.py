...
for x in range (0,8):
	subprocess.run(["/home/rileyrob/ModestFiles/Modest/modest", "mcsta", "BurstyMode.modest", "-E", "DUR = 100, Mvar = %s, Nvar = %s, Startvar = %s" % (str(M), str(N), str(x)), "--unsafe", "-O", str(output[x])])
